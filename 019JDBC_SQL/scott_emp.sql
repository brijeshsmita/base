...
INSERT INTO DEPT_FK VALUES (30,'SALES','CHICAGO');
INSERT INTO DEPT_FK VALUES (40,'OPERATIONS','BOSTON');
...
CREATE TABLE EMP (
 ...
 COMM                NUMBER(7,2),
 DEPTNO              NUMBER(2) NOT NULL,
 CONSTRAINT EMP_FOREIGN_KEY FOREIGN KEY (DEPTNO) REFERENCES DEPT_FK (DEPTNO),
...
INSERT INTO EMP VALUES (8104,'MILLER','CLERK',7782,'23-JAN-82',1300,NULL,10);

CREATE TABLE MESSAGES (
 MESSAGE_ID			NUMBER(3),
 MESSAGE_TEXT		VARCHAR2(30),
 NEXT_MESSAGE_ID	NUMBER(3)
 );
