        ...
        <table border="20" align="center" style="background-color: silver;">
         ...
         <%--  <% if (action.equalsIgnoreCase("edit")) {%>
            ...
            <td><select id="deptId" name="deptId">
                	<option value="<c:out value="${employee.deptId}" />">Id</option>
        		</select></td>
            ...
            <%} else {%> 
              ...
              <td><select id="projectId" name="projectId" >
                	<option value="<c:out value="${employee.projectId}" />">Id</option>
        		</select>
        		</td>
            ...
            <%} else {%> 
             ...
             <td><select id="roleId" name="roleId" >
                	<option value="<c:out value="${employee.roleId}" />">Id</option>
        		</select></td>
